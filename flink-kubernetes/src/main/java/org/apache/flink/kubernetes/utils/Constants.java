...
public class Constants {
    ...
    public static final String STREAM_GRAPH_STORE_KEY_PREFIX = "streamGraph-";
    public static final String SUBMITTED_STREAM_GRAPH_FILE_PREFIX = "submittedStreamGraph";
