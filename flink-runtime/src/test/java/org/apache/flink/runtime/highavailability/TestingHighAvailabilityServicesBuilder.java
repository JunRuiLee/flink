...
public class TestingHighAvailabilityServicesBuilder {
    ...
    private StreamGraphStore streamGraphStore = new StandaloneStreamGraphStore();
    ...
    public TestingHighAvailabilityServices build() {
        ...
        testingHighAvailabilityServices.setStreamGraphStore(streamGraphStore);
    ...
    public TestingHighAvailabilityServicesBuilder setStreamGraphStore(
