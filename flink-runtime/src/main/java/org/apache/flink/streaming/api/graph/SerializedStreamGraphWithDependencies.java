 ...
 * and used.
 */
public class SerializedStreamGraphWithDependencies implements ExecutionPlan {
    ...
    /**
     * Constructs a new SerializedStreamGraphWithDependencies instance.
     *
     * @param streamGraph the StreamGraph to be serialized and transferred
     */
    private SerializedStreamGraphWithDependencies(
        ...
        this.isEmptyGraph = streamGraph.getStreamNodes().size() == 0;
