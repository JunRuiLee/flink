 ...
 *
 * <p>The mini dispatcher is initialized with a single {@link StreamGraph} which it runs.
 *
...
public class MiniDispatcher extends Dispatcher {
    ...
    public MiniDispatcher(
        ...
        super(
                rpcService,
                fencingToken,
                CollectionUtil.ofNullable(streamGraph),
    ...
    public CompletableFuture<Acknowledge> submitJob(StreamGraph streamGraph, Time timeout) {
        final CompletableFuture<Acknowledge> acknowledgeCompletableFuture =
                super.submitJob(streamGraph, timeout);
