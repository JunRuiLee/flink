...
public class ForwardGroupComputeUtil {
    ...
    public static boolean canTargetMergeIntoSourceForwardGroup(
        ...
        // When the maximum parallelism of both forward groups is determined, the maximum
        // parallelism of the targetForwardGroup should not be less than that of the
        // sourceForwardGroup. This is because when the source has finished deciding its
        // parallelism, we need to ensure that the targetForwardGroup can also achieve the same
        // parallelism.
