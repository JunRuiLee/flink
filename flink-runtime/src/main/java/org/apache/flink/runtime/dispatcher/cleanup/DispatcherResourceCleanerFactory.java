...
public class DispatcherResourceCleanerFactory implements ResourceCleanerFactory {
    ...
    private static final String STREAM_GRAPH_STORE_LABEL = "StreamGraphStore";
    ...
    public DispatcherResourceCleanerFactory(
        ...
        this(
                ...
                dispatcherServices.getStreamGraphWriter(),
    ...
    public DispatcherResourceCleanerFactory(
        ...
        this.streamGraphWriter = Preconditions.checkNotNull(streamGraphWriter);
    ...
    public ResourceCleaner createLocalResourceCleaner(
        ...
        return DefaultResourceCleaner.forLocallyCleanableResources(
                ...
                .withRegularCleanup(STREAM_GRAPH_STORE_LABEL, streamGraphWriter)
