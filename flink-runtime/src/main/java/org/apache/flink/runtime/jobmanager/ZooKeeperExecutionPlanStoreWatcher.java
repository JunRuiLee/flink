...
public class ZooKeeperExecutionPlanStoreWatcher implements ExecutionPlanStoreWatcher {
    ...
    private ExecutionPlanStore.ExecutionPlanListener jobGraphListener;
    ...
    @Override
    public void start(ExecutionPlanStore.ExecutionPlanListener jobGraphListener) throws Exception {
                ...
                case CHILD_ADDED:
                    {
                        ...
                        jobGraphListener.onAddedExecutionPlan(jobId);
                    }
                    break;
