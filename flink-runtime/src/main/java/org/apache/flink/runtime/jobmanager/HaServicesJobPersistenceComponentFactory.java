...
/**
 * {@link JobPersistenceComponentFactory} implementation which creates a {@link StreamGraphStore}
...
public class HaServicesJobPersistenceComponentFactory implements JobPersistenceComponentFactory {
    ...
    public StreamGraphStore createStreamGraphStore() {
        return create(highAvailabilityServices::getStreamGraphStore, StreamGraphStore.class);
    }
