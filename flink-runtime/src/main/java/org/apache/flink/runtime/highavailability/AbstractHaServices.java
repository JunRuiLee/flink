...
public abstract class AbstractHaServices implements HighAvailabilityServices {
    ...
    @Override
    public StreamGraphStore getStreamGraphStore() throws Exception {
        return createStreamGraphStore();
    }
     ...
     */
    protected abstract StreamGraphStore createStreamGraphStore() throws Exception;
